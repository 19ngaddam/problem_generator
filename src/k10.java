...
public class k10 extends Problem{
    static String prob="A ball is shot from height 1 m with angle 2 ° and velocity 2 m/s. How far does it horizontally travel? Round to the nearest hundredth.";
    ...
    public double solve() {
        ...
        sol=vi*Math.cos(Math.toRadians(t))*sol;
